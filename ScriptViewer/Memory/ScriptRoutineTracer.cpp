...
namespace Memory
{
	...
	{
		if (!pScriptRoutineTracer || std::find(ms_rgScriptRoutineTracers.begin(), ms_rgScriptRoutineTracers.end(), pScriptRoutineTracer)
	...
	void UnregisterTraceCallback(ScriptRoutineTracer* pScriptRoutineTracer)
	{
		...
		const auto& result = std::find(ms_rgScriptRoutineTracers.begin(), ms_rgScriptRoutineTracers.end(), pScriptRoutineTracer);
